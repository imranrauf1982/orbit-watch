...
export const metadata: Metadata = {
  // ... your metadata stays exactly the same
  title: 'Blog — Satellite Tracking Guides & Space Insights | OrbitMap',
  description: 'Explainers and guides on satellite tracking, orbital mechanics, TLE data, and how to spot the ISS — from the team behind OrbitMap.',
  // ... (rest of metadata unchanged)
}

const jsonLd = { /* ... your jsonLd stays the same */ }
...
export default async function BlogPage() {
  ...
  if (error) {
    ...
    return (
      <div className="min-h-screen pt-24 text-red-400 p-10 text-center">
        Error loading blog posts: {error.message}
      </div>
    )
  }

  console.log(`✅ Loaded ${posts?.length || 0} live blog posts`)
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto text-sm">
              Explainers, guides, and deep dives on satellite tracking, orbital mechanics, and how to make sense of the data behind the map.
            </p>
          </div>
